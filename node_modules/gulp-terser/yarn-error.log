Arguments: 
  /usr/local/bin/node /usr/local/Cellar/yarn/1.9.4/libexec/bin/yarn.js add gulp@next --dev

PATH: 
  /Applications/mkcert:/Library/Frameworks/Python.framework/Versions/3.6/bin:/Library/Frameworks/Python.framework/Versions/2.7/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/opt/X11/bin
...
Trace: 
  Error: https://registry.yarnpkg.com/gulp: ETIMEDOUT
...
Lockfile: 
  ...
  acorn@5.X, acorn@^5.0.3, acorn@^5.6.0:
    version "5.7.3"
